...
public class UserIntegrationTest {
    ...
    public void testPostsIndex() throws Exception {
        ...
        // Makes a Get request to /ads and verifies that we get some of the static text of the posts/index.html template and at least the title from the first Post is present in the template.
